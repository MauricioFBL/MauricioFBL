...
Senior Data Engineer with 8+ years designing and running data platforms across **AWS** and **GCP**. Currently building data pipelines and BI infrastructure at **L'Oréal México**, with prior experience at Fender and Kellogg's. Pursuing a Master's in Data Science and moving toward **Staff / Principal Data Engineer** and **AI Engineer** roles.

*I think in terms of platforms, not one-off pipelines — storage, orchestration, and cost/maintainability tradeoffs designed together, not bolted on later.*
